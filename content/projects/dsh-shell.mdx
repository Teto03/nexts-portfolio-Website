---
title: "DSH Shell"
description: A minimal Unix shell in C built to understand what happens under the hood — path lookup, output redirection and pipes through POSIX system calls (fork, exec, dup2, pipe).
